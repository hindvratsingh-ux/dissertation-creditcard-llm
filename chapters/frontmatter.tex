...
This research did not involve human participants, real personal data, or any other activity requiring ethics approval, and therefore no application to the Departmental Ethics Committee was required (see Section~3.6 for the full ethical-considerations statement).
...
I declare that the word count for this dissertation (excluding title page, declaration, abstract, acknowledgements, table of contents, list of illustrations, references and appendices) is \textbf{8,333} words at the time of this draft, to be confirmed at final submission.
...
I would like to thank my dissertation supervisor, [Supervisor's Name], for their guidance and feedback throughout this project, particularly in shaping the baseline methodology and the scale of the experimental dataset.
